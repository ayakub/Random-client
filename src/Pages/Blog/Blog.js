    ...
    <div className="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 mx-10 my-20">
      <div className="card  bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title text-primary">
            what is the different ways to manage a state in a react application?
          </h2>
          <p>
      ...
      <div className="card  bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p>
            ...
            methods, just build a new object on top of it.Prototypal inheritance
            is a language feature that helps in that.Accessor properties are an
            exception, as assignment is handled by a setter function. So writing
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p>
            <span className="text-primary">Unit Testing</span> is a type of
            software testing where individual units or components of a software
            are tested.The purpose is to validate that each unit of the software
            ...
            Tests isolate a section of code and verify its correctness.A unit
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <p>
            <span className="text-primary">React</span> developed by Facebook,
            was initially released in 2013. Facebook uses React extensively in
            their products (Facebook, Instagram, and WhatsApp). Similar to Vue,
            the React developers also announce their newest version on the
            <span className="text-primary">Angular</span> developed by Google,
            was first released in 2010, making it the oldest of the lot. It is a
            TypeScript-based JavaScript framework. A substantial shift occurred
            in 2016 on the release of Angular 2 (and the dropping of the “JS”
            from the original name – AngularJS). Angular 2+ is known as just
            Angular. Although AngularJS (version 1) still gets updates, we will
            focus the discussion on Angular. <br />
            <span className="text-primary">Vue</span> also known as Vue.js, is
            the youngest member of the group. It was developed by ex-Google
            employee Evan You in 2014. Over the last several years, Vue has seen
            a substantial shift in popularity, even though it doesn’t have the
            backing of a large company. <br />
          </p>
        </div>
      </div>
    </div>
