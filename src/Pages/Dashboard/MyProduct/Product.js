...
const Product = ({ myProduct, handdleDeleteProduct }) => {
  ...
  const handleAdvertisment = (id) => {
    console.log(id);
    fetch(
      `https://reused-product-sell-server-ayakub.vercel.app/advertiesment?id=${id}`,
      {
        method: "PUT",
      }
    )
  ...
  return (
    <div className="card bg-base-100 shadow-xl mb-10 pb-10 mt-10">
        ...
        <div className="">
          <h2 className=" ">
            ...
            <span className="font-semibold text-red-600">
              : {seller ? seller : "seller name not avilable"}
            </span>
          </h2>
      ...
      <div className="flex justify-around">
        <button
          onClick={() => handleAdvertisment(myProduct._id)}
        ...
        <button
          onClick={() => handdleDeleteProduct(myProduct._id)}
