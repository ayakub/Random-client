...
const CatagoriesPost = () => {
    ...
    fetch(url, {
      ...
      .then((imgData) => {
        if (imgData.success) {
          ...
          fetch(
            "https://reused-product-sell-server-ayakub.vercel.app/catagory",
            {
              method: "POST",
              headers: {
  ...
  return (
    <div className="flex justify-center items-center mb-10">
      <div className="p-7">
        <h2 className="text-4xl text-primary font-semibold mb-5 text-center">
          Add a Car
        </h2>
        <form onSubmit={handleSubmit(handleAddProduct)}>
          <div className="grid gap-10 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              <label className="label">
                {" "}
                <span className="label-text">Chose Catagory</span>
              </label>
              <select
          ...
          <div className="flex justify-center">
            <input
              className="btn btn-primary mt-5 w-full md:w-1/2 lg:w-1/2"
              value="Add a product"
              type="submit"
            />
          </div>
